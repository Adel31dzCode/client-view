...
export default function AdmissionPageDap() {
    ...
    <div id="services-continer-admission">
        <div id="service-complet">
          ...
          <p id="desc_service_complet">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi sed eaque error odio illum, alias quo. Obcaecati nam, dolor velit cumque eveniet reprehenderit placeat corrupti laborum consequatur! Quae, assumenda debitis.</p>
            <button 
                type="button" className='acceder-btn' id='complet_service_btn'
                onClick={() => window.location.href = "/service-complet-dap"}
              >
                Acceder
            </button>
        </div>
          ...
          <div id="forms-checksboxes-continer">
            ...
            <form>
              ...
              <button 
                ...
                type="button"
                onClick={() => navigate("/Service-dap-one")}
              >
                Acceder
              </button>
            </form>
            ...
            <form>
              ...
              <button 
                className='acceder-btn' 
                type="button"
                onClick={() => navigate("/Service-dap-two")}
              >
                Acceder
              </button>         
              </form>
            ...
            <form>
              ...
              <button 
                className='acceder-btn'
                type="button" 
                onClick={() => navigate("/Service-dap-three")}
              >
                Acceder
              </button>
            </form>
