...
export default function ServiceCompletHorz({ UserExisting }) {
  return (<>
    ...
    <div id="page-service">
      ...
      <section id='section-content'>
        <h1>Procédure d'inscription Hors DAP (Hors Demande d'Admission Préalable)</h1>
        
        <p className="intro-text-service">Cette procédure concerne les étudiants déjà inscrits dans l'enseignement supérieur qui souhaitent poursuivre leurs études en France en intégrant directement une L2, L3, Licence Professionnelle, Master, BUT ou école publique.</p>
        ...
        <h2 className="title-service" id='serice3-title'>
          <img src={list_style} alt="list-style" /> 2- Constitution de dossier :
        </h2>
        <p className="para-content-service">
        ...
        <h2 className="title-service" id='serice4-title'>
          <img src={list_style} alt="list-style" /> 3- Panier de formation :
        </h2>
        <p className='para-content-service'>
        ...
        <p className='para-content-service'>
          <span className='color-main-services'>Rédaction des lettres de motivation :</span> Nous rédigeons pour vous <strong>sept lettres de motivation entièrement personnalisées</strong> afin de maximiser l'impact de votre candidature, adaptées à chaque université et formation.
        </p>
        ...
        <h2 className="title-service" id='serice5-title'>
          <img src={list_style} alt="list-style" /> 4- Préparation à l'entretien
        </h2>
        ...
        <h2 className="title-service" id='serice6-title'>
          <img src={list_style} alt="list-style" /> 5- Recours gracieux
        </h2>
