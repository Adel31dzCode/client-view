...
export default function CompletSerivce() {
  return (<>
 ...
 <div id="page-service">
      ...
      <section id='section-content'>
        ...
        <ul className="service-list">
          <li>
            <strong>Rédaction d'un CV professionnel :</strong> un CV adapté à votre candidature, qui résume correctement votre parcours, met en avant les <strong>points forts</strong> de votre dossier et valorise les <strong>compétences recherchées</strong> par les universités choisies, en cohérence avec votre projet d'études.
          </li>
          <li>
            <strong>Rédaction d'une lettre explicative :</strong> si votre dossier le nécessite, nous préparons une lettre claire et persuasive, dotée d'une <strong>argumentation solide</strong> et d'une excellente <strong>qualité rédactionnelle</strong>.
          </li>
          <li>
            <strong>Optimisation des lettres de recommandation :</strong> si vos professeurs vous ont fourni des lettres simples, nous les retravaillons pour les renforcer et mettre en valeur vos <strong>atouts académiques et personnels</strong>.
          </li>
        </ul>
